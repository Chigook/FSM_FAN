...
set_property -dict { PACKAGE_PIN U17  IOSTANDARD LVCMOS33 } [get_ports { i_button[3] }]; #IO_L18P_T2_A12_D28_14 ,Sch=BTND
...
set_property -dict { PACKAGE_PIN K17  IOSTANDARD LVCMOS33 } [get_ports { o_motor }]; #IO_L12N_T1_MRCC_14 ,Sch=JC1
